export const styles = {
    ...
    container: "relative m-5 w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700",
    form: "space-y-1",
    ...
    body: "absolute top-0 left-0 w-full h-auto bg-black bg-opacity-75 grid place-items-center",
